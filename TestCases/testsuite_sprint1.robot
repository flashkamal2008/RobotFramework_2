...
*** Test Cases ***
Test Case 001
    [Documentation]  Testcase to validate basic login in Edge Browser
    [Tags]  logincheck
    ...
    #Browser initiation
    Navigate Browser    ${Application_URL}  edge
...
Test Case 002
    [Documentation]  Testcase to validate basic login in Chrome Browser
    [Tags]  logincheck 002-chrome Browser
